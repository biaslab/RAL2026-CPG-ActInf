...
the shared engine; the per-terrain runners that call it with their terrain config
(experiment-flat, experiment-sloped) and the cross-terrain comparison figure
(experiment-flat2sloped) now live under archive/experiments/. Attitude is in the physical convention (see

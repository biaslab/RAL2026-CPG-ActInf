...
# The CPG controllers now live in methods.cpg_controller (pure NumPy, no
# simulator) so the real-robot scripts in experiment-real/ can drive the exact
# same controller without importing pybullet. Re-exported here because every
# existing call site does `from methods.marxefe_optimizer import JointCPG`.
from methods.cpg_controller import JointCPG, PerLegCPG      # noqa: E402,F401
